...
#elif EVENT == EVENT_UK
// RAW values for the front sensor when the robot is backed up to a wall
const int FRONT_LEFT_CALIBRATION = 186;
const int FRONT_RIGHT_CALIBRATION = 173;
// RAW side sensor values when robot is centred in a cell and no wall ahead
const int LEFT_CALIBRATION = 286;
const int RIGHT_CALIBRATION = 300;
...
const float WHEEL_DIAMETER = 31.40;
...
const float ROTATION_BIAS = 0.0000;  //-0.0017;  // Negative makes robot curve to left

// SVB To further calibrate the robot you may need to tweak the Turn Parameters??
...
// SVB - Slow down movement for analysis
// const int SEARCH_SPEED = 40;
// const int SEARCH_ACCELERATION = 200;
// const int SEARCH_TURN_SPEED = 30;
// const int SMOOTH_TURN_SPEED = 50;
// const int FAST_TURN_SPEED = 60;
...
const TurnParameters turn_params[4] = {
    ...
    {SEARCH_TURN_SPEED,    60,     80,  90.0, 287.0, 2866.0, TURN_THRESHOLD_SS90E}, // 0 => SS90EL
    {SEARCH_TURN_SPEED,    60,     80, -90.0, 287.0, 2866.0, TURN_THRESHOLD_SS90E}, // 0 => SS90ER
